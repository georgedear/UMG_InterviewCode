...
public class ContractServiceTests
{
    ...
    [
        new("Tinie Tempah", "Frisky (Live from SoHo)", ["digital download", "streaming"], new DateOnly(2012, 2, 1), null),
        new("Tinie Tempah", "Miami 2 Ibiza", ["digital download"], new DateOnly(2012, 2, 1), null),
        new("Tinie Tempah", "Till I'm Gone", ["digital download"], new DateOnly(2012, 8, 1), null),
        new("Monkey Claw", "Black Mountain", ["digital download"], new DateOnly(2012, 2, 1), null),
        new("Monkey Claw", "Iron Horse", ["digital download", "streaming"], new DateOnly(2012, 6, 1), null),
        new("Monkey Claw", "Motor Mouth", ["digital download", "streaming"], new DateOnly(2011, 3, 1), null),
        new("Monkey Claw", "Christmas Special", ["streaming"], new DateOnly(2012, 12, 25), new DateOnly(2012, 12, 31)),
    ];
